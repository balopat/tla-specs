...
\setboolean{shading}{true}
 ...
 IdGeneratorByteCode}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\EXTENDS} Integers ,\, Sequences ,\,\@s{4.1} TLC}%
\@pvspace{8.0pt}%
\@x{ {\CONSTANT}\@s{4.1} NumberOfProcesses ,\, Locking}%
\@pvspace{8.0pt}%
\pcalsymbolstrue
\csyntaxtrue
\@x{ {\p@mmfair} {\p@algorithm} IdGenerator {\p@lbrace}}%
\@pvspace{8.0pt}%
\@x{\@s{8.2} {\p@variable}}%
\@x{\@s{8.2} this \.{=} [ lastId \.{\mapsto} 42 ,\, lock \.{\mapsto} 0 ] ,\,}%
 \@x{\@s{8.2} stacks \.{=} [ i \.{\in} 1 \.{\dotdot} NumberOfProcesses
 \.{\mapsto} {\langle} {\rangle} ] ,\,}%
 \@x{\@s{8.2} returnValue \.{=} [ i \.{\in} 1 \.{\dotdot} NumberOfProcesses
 \.{\mapsto} \.{-} 1 ]}%
\@x{\@s{8.2} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{\@s{8.2} {\p@define} {\p@lbrace}}%
\@x{\@s{16.4} Last ( S ) \.{\defeq} S [ Len ( S ) ]}%
\@x{\@s{16.4} Pop ( S ) \.{\defeq} SubSeq ( S ,\, 1 ,\, Len ( S ) \.{-} 1 )}%
 \@x{\@s{16.4} AllIsDone \.{\defeq}\@s{4.1} ( \A\, i \.{\in} 1 \.{\dotdot}
 NumberOfProcesses \.{:} pc [ i ] \.{=}\@w{Done} )}%
 \@x{\@s{16.4} AllStacksAreEmpty \.{\defeq}\@s{4.1} ( \A\, i \.{\in} 1
 \.{\dotdot} NumberOfProcesses \.{:} stacks [ i ] \.{=} {\langle} {\rangle}
 )}%
 \@x{\@s{16.4} IdsAreAllDifferent \.{\defeq} ( \A\, i ,\, j \.{\in} 1
 \.{\dotdot} NumberOfProcesses \.{:} i \.{\neq} j \.{\implies} returnValue [
 i ] \.{\neq} returnValue [ j ] )}%
 \@x{\@s{16.4} IdGeneratorInvariant \.{\defeq} AllIsDone \.{\implies}
 AllStacksAreEmpty \.{\land} IdsAreAllDifferent}%
\@x{\@s{8.2} {\p@rbrace}}%
\@pvspace{8.0pt}%
\@x{\@s{8.2}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{8.2} {\p@process} {\p@lparen} id \.{\in} 1 \.{\dotdot}
 NumberOfProcesses {\p@rparen} {\p@lbrace}}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 if \ensuremath{Locking} constant is \ensuremath{{\TRUE}}, then we
 can\mbox{'}t start the process of executing \ensuremath{\.{\pp}lastId}
 unless the lock is unlocked
}%
\@xx{}%
 \@x{\@s{16.4} checkLocking\@s{.5}\textrm{:}\@s{3} {\p@if} {\p@lparen} Locking
 {\p@rparen} {\p@lbrace}}%
\@x{\@s{106.45} waitForLock\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{122.85} {\p@await} this . lock \.{=} 0 {\p@semicolon}}%
\@x{\@s{122.85} this . lock \.{:=} self {\p@semicolon}}%
\@x{\@s{83.51} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 Load \ensuremath{\_this\_} onto the operand stacks
}%
\@xx{}%
 \@x{\@s{16.4} aload0\@s{.5}\textrm{:}\@s{3} stacks [ self ] \.{:=} Append (
 stacks [ self ] ,\, this ) {\p@semicolon}}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 copy the top of the stacks
}%
\@xx{}%
 \@x{\@s{16.4} dup\@s{.5}\textrm{:}\@s{3} stacks [ self ] \.{:=} Append (
 stacks [ self ] ,\, Last ( stacks [ self ] ) ) {\p@semicolon}}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 retrieve the value of field \ensuremath{lastId} from \ensuremath{\_this\_}
 and store it back on the top of the stacks
}%
\@xx{}%
\@x{\@s{16.4} getfield\_lastId\@s{.5}\textrm{:}\@s{3}}%
 \@x{\@s{41.0} {\p@with} {\p@lparen} lastId \.{=} Last ( stacks [ self ] ) .
 lastId {\p@rparen} {\p@lbrace}}%
 \@x{\@s{49.2} stacks [ self ] \.{:=} Append ( Pop ( stacks [ self ] ) ,\,
 lastId ) {\p@semicolon}}%
...
\@xx{}%
 \@x{\@s{16.4} iconst\_1\@s{.5}\textrm{:}\@s{3} stacks [ self ] \.{:=} Append
 ( stacks [ self ] ,\, 1 ) {\p@semicolon}}%
\@x{\@s{20.5}}%
\@y{\@s{0}%
 integer add the top two values on the top of the stacks
}%
\@xx{}%
\@x{\@s{16.4} iadd\@s{.5}\textrm{:}\@s{3}}%
 \@x{\@s{32.8} {\p@with} {\p@lparen} a \.{=} Last ( stacks [ self ] ) ,\, b
 \.{=} Last ( Pop ( stacks [ self ] ) ) {\p@rparen} {\p@lbrace}}%
 \@x{\@s{49.19} stacks [ self ] \.{:=} Append ( Pop ( Pop ( stacks [ self ] )
 ) ,\, a \.{+} b ) {\p@semicolon}}%
...
\@xx{}%
\@x{\@s{16.4} dup\_x1\@s{.5}\textrm{:}\@s{3}}%
 \@x{\@s{32.8} stacks [ self ] \.{:=} {\langle} Last ( stacks [ self ] )
 {\rangle} \.{\circ} stacks [ self ] {\p@semicolon}}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
...
\@x{\@s{16.4}}%
\@y{\@s{0}%
 current object, represented by the net-to-top value on the operand stack,
 \ensuremath{\_this\_
}}%
\@xx{}%
\@x{\@s{16.4} putfield\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{32.8} this . lastId \.{:=} Last ( stacks [ self ] ) {\p@semicolon}}%
 \@x{\@s{32.8} stacks [ self ] \.{:=} Pop ( Pop ( stacks [ self ] ) )
 {\p@semicolon}}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 return the \ensuremath{top(and} \ensuremath{only)} value on the stack
}%
\@xx{}%
\@x{\@s{16.4} ireturn\@s{.5}\textrm{:}\@s{3}}%
 \@x{\@s{32.8} returnValue [ self ] \.{:=} Last ( stacks [ self ] )
 {\p@semicolon}}%
\@x{\@s{32.8} stacks [ self ] \.{:=} Pop ( stacks [ self ] ) {\p@semicolon}}%
\@x{\@s{20.5} {\p@if} {\p@lparen} Locking {\p@rparen} {\p@lbrace}}%
 \@x{\@s{31.04} unlock\@s{.5}\textrm{:}\@s{3} this . lock \.{:=} 0
 {\p@semicolon}}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 13 15:22:05 \ensuremath{EST} 2015 by \ensuremath{balopat
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Thu} \ensuremath{Dec} 10
 19:27:24 \ensuremath{EST} 2015 by \ensuremath{balopat
}%
\end{cpar}%
\end{lcom}%
\end{document}
