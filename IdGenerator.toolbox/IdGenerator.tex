...
\@x{}\moduleLeftDash\@xx{ {\MODULE} IdGenerator}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\EXTENDS} Integers ,\, TLC}%
\@pvspace{8.0pt}%
\@x{ {\CONSTANT}\@s{4.1} NumberOfProcesses}%
\@pvspace{8.0pt}%
\pcalsymbolstrue
\csyntaxtrue
\@x{ {\p@mmfair} {\p@algorithm} IdGenerator {\p@lbrace}}%
\@pvspace{8.0pt}%
 \@x{\@s{8.2} {\p@variable} lastIdUsed \.{=} 42 ,\, processIds \.{=} [ i
 \.{\in} 1 \.{\dotdot} NumberOfProcesses \.{\mapsto} 0 ] {\p@semicolon}}%
\@pvspace{8.0pt}%
...
\@xx{}%
 \@x{\@s{16.4} update\@s{.5}\textrm{:}\@s{3}\@s{4.1} lastIdUsed \.{:=}
 lastIdUsed \.{+} 1 {\p@semicolon}}%
 \@x{\@s{16.4} read\@s{.5}\textrm{:}\@s{3}\@s{13.91} processIds [ self ]
 \.{:=} lastIdUsed}%
\@x{\@s{8.2} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
...
\@xx{}%
\@x{ {\VARIABLES} lastIdUsed ,\, processIds ,\, pc}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 define statement
...
\@xx{}%
 \@x{ AllIsDone \.{\defeq}\@s{4.1} ( \A\, i \.{\in} 1 \.{\dotdot}
 NumberOfProcesses \.{:} pc [ i ] \.{=}\@w{Done} )}%
 \@x{ IdsAreAllDifferent \.{\defeq} ( \A\, i ,\, j \.{\in} 1 \.{\dotdot}
 NumberOfProcesses \.{:} i \.{\neq} j \.{\implies} processIds [ i ] \.{\neq}
 processIds [ j ] )}%
 \@x{ IdGeneratorInvariant \.{\defeq} AllIsDone \.{\implies}
 IdsAreAllDifferent}%
\@pvspace{16.0pt}%
\@x{ vars \.{\defeq} {\langle} lastIdUsed ,\, processIds ,\, pc {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ProcSet \.{\defeq} ( 1 \.{\dotdot} NumberOfProcesses )}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
\@x{\@s{35.70} \.{\land} lastIdUsed \.{=} 42}%
 \@x{\@s{35.70} \.{\land} processIds\@s{1.64} \.{=} [ i \.{\in} 1 \.{\dotdot}
 NumberOfProcesses \.{\mapsto} 0 ]}%
 \@x{\@s{35.70} \.{\land} pc \.{=} [ self\@s{3.49} \.{\in} ProcSet
 \.{\mapsto}\@w{update} ]}%
\@pvspace{8.0pt}%
\@x{ update ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{update}}%
\@x{\@s{71.95} \.{\land} lastIdUsed \.{'} \.{=} lastIdUsed \.{+} 1}%
 \@x{\@s{71.95} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{read} ]}%
\@x{\@s{71.95} \.{\land} {\UNCHANGED} processIds}%
\@pvspace{8.0pt}%
\@x{ read ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{read}}%
 \@x{\@s{62.14} \.{\land} processIds \.{'} \.{=} [ processIds {\EXCEPT}
 {\bang} [ self ] \.{=} lastIdUsed ]}%
 \@x{\@s{62.14} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{Done} ]}%
\@x{\@s{62.14} \.{\land} {\UNCHANGED} lastIdUsed}%
\@pvspace{8.0pt}%
\@x{ id ( self ) \.{\defeq} update ( self ) \.{\lor} read ( self )}%
\@pvspace{8.0pt}%
 \@x{ Next \.{\defeq} ( \E\, self \.{\in} 1 \.{\dotdot} NumberOfProcesses
 \.{:} id ( self ) )}%
\@x{\@s{47.82} \.{\lor}}%
\@y{\@s{0}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Dec} 13
 13:38:46 \ensuremath{EST} 2015 by \ensuremath{balopat
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Dec} 04
 17:18:27 \ensuremath{EST} 2015 by \ensuremath{balopat
}%
\end{cpar}%
\end{lcom}%
\end{document}
